...
class Device { 
      ...
      function check_country($id){
                   $data = file_get_contents("http://ip-api.com/json/".$id."?fields=country,countryCode,proxy,hosting");
                   //$data = file_get_contents("http://ip-api.com/json/20.239.182.106?fields=country,countryCode,proxy,hosting");
...
$data['country'] = $device->check_country($data['ip']);
